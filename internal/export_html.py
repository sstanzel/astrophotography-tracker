...
Reads the SQLite database produced by scan.py and writes a single
...
It is a snapshot — re-run refresh.py to update.
...
<div class="foot">Generated by export_html.py from tracker.db — re-run refresh.py to update.</div>
