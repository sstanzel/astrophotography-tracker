...
**📄 [Read the paper (PDF)](docs/Astrophotography_v2_organization_paper.pdf)**

![The tracker dashboard — headline cards, integration by year, top targets by lifetime hours](docs/figures/dashboard.png)

*The dashboard's summary layer, regenerated by one command after each capture night.*
